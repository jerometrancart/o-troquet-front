    ...
    <>
      ...
      <div className="playModes">
        <div className="modes">
          ...
          <Button color="grey" className="center aligned" onClick={webSocketGetRoom}>Quick play
            {/* <Button className="center aligned"
            onClick={webSocketJoinRoom.bind(this, roomId)}>Quick play */}
          </Button>
          {/* </Link> */}
          {/* <Link to="/"> */}
          <Button color="grey" className="center aligned" onClick={webSocketCreateRoom}>Invite friends
          </Button>
          {/* </Link> */}
        </div>
